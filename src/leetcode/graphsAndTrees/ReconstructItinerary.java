...
public class ReconstructItinerary {
    public static void main(String[] args) {
        ReconstructItinerary x = new ReconstructItinerary();
        String[][] w = {{"MUC","LHR"},{"JFK","MUC"},{"SFO","SJC"},{"LHR","SFO"}};

        //A list can be printed with one sout statement
        System.out.println(x.findItinerary(w));
    }

    //DFS based recursive algo
    //TODO: Implementing the Heizerholer's algo is pending....
