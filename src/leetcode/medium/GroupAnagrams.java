...
public class GroupAnagrams {
    ...
    private int insertIfAnagramExists(List<List<String>> res, String word){
        ...
        while(i <= j){
            mid = (i+j)/2;
            List<String> li = res.get(mid);
            int compared = sortedWord.compareTo(li.get(0));
            if(compared > 0){
                i = mid +1;
            }else if(compared < 0){
                j = mid-1;
